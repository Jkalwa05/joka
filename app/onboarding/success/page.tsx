...
const content = {
  autochat: {
    ...
    next: 'Unser Team meldet sich bei dir um deine Geschäftsnummer zu verbinden.',
  },
  mailpilot: {
    title: 'MailPilot ist verbunden!',
    text: 'Dein Postfach ist jetzt verbunden. MailPilot sortiert ab sofort jede neue E-Mail automatisch in den richtigen Ordner.',
    next: 'Neue E-Mails werden automatisch sortiert. Eingehende Termine landen direkt in deinem Kalender.',
  },
}
...
export default function SuccessPage({ searchParams }: Props) {
  ...
  return (
    <div style={{ maxWidth: '520px', margin: '6rem auto', padding: '0 1.5rem', textAlign: 'center' }}>
      ...
      <PwaInstallPrompt />
      <a href="/" className="btn-secondary" style={{ display: 'inline-block', marginTop: '1.5rem' }}>Zurück zur Startseite</a>
    </div>
  )
}
