    ...
    return (
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
          ...
          <strong style={{ color: 'var(--text-main)', fontSize: '1rem' }}>Joka als App installieren</strong>
        </div>
        <p style={{ fontSize: '0.88rem', color: 'var(--text-muted)', margin: '0 0 1rem 0', lineHeight: 1.5 }}>
          Füge Joka zu deinem Homescreen hinzu – so hast du die Inbox immer direkt zur Hand.
        </p>
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1 }}>
        ...
        <p style={{ fontSize: '0.88rem', color: 'var(--text-muted)', margin: '0 0 1rem 0', lineHeight: 1.5 }}>
          Füge Joka zu deinem Homescreen hinzu – Inbox immer direkt zur Hand, ohne Browser.
        </p>
